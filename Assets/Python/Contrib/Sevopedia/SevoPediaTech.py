...
class SevoPediaTech(CvPediaScreen.CvPediaScreen):
	...
	def placeSpecial(self):
		...
		# Advanced Settlers text - START
		if self.iTech == gc.getInfoTypeForString("TECH_COLONIALISM"):
			szSpecialText += localText.getText("TXT_KEY_COLONAILISM_EXTRA_POP", ())
		if self.iTech == gc.getInfoTypeForString("TECH_STEAM_POWER"):
			szSpecialText += localText.getText("TXT_KEY_STEAM_POWER_EXTRA_POP", ())
		# Advanced Settlers text - END
