...
class BugNJAGCOptionsTab(BugOptionsTab.BugOptionsTab):
	...
	def create(self, screen):
		...
		self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_PREHISTORIC", True)
...
# Rise of Mankind 2.7
		self.addColorDropdown(screen, rightPanelL, rightPanelR, "NJAGC__Color_ERA_GALACTIC", True)
