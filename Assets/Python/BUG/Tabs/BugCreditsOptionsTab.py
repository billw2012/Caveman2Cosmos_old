...
credits = [ 
			"-", "Caveman2Cosmos",
			"StrategyOnly - C2C, Prehistoric Era, Galactic Era, Original Civics Screen",
			"Hydromancerx - Ideas Guy, Feedback, Designer, Artwork",
			"DancingHoskuld - Ideas, Feedback, Designer, Subdue Animals, Religions, Temporary Caveman2Cosmos mod boss",
			"Koshling - Ideas, Feedback, C2C SDK Designer",
			"alberts2 - Ideas, Feedback, C2C SDK Designer",
			"AIAndy - Ideas, Feedback, SDK Designer",
			"Thunderbrd - Ideas, Feedback, SDK Designer",
			"Yudishtira - Ideas, Feedback, Unitnologist",
			"Sparth - Graphics Re-Skinner, Ideas, Feedback, some XML",
			"ori - Ideas, Designer for Events XML",
			"MrAzure - Ideas, Transhuman Era, PR Person, Technologist, Artwork",
			"CIVPlayer8 - Civicologist",
			"Sgtslick - LH Traitologist",
			"rightfuture - Ideas, PR person",
			"Faustmouse - XML AssistantIdeas, Feedback",
			"ls612 - Ideas, Feedback",
